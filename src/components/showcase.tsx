...
const SITES = [
  {
    ...
    score: 98,
    color: '#3b82f6',
    url: 'https://demo-hvac.pages.dev',
    domain: 'demo-hvac.pages.dev',
  },
  {
    biz: 'Peak Roofing Co.',
    niche: 'Roofing',
    ...
    score: 97,
    color: '#ef4444',
    url: 'https://demo-roofing.pages.dev',
    domain: 'demo-roofing.pages.dev',
  },
  {
    biz: 'Bright Smile Dentistry',
    niche: 'Dentistry',
    city: 'San Jose, CA',
    ...
    score: 97,
    color: '#06b6d4',
    url: 'https://demo-dentist.pages.dev',
    domain: 'demo-dentist.pages.dev',
  },
  {
    biz: 'Sparkle Cleaning Co.',
    niche: 'Cleaning',
    ...
    score: 96,
    color: '#8b5cf6',
    url: 'https://demo-cleaning.pages.dev',
    domain: 'demo-cleaning.pages.dev',
  },
  {
    biz: 'Green Thumb Landscaping',
    niche: 'Landscaping',
    city: 'Fresno, CA',
    ...
    score: 97,
    color: '#22c55e',
    url: 'https://demo-landscaping.pages.dev',
    domain: 'demo-landscaping.pages.dev',
  },
  {
    ...
    domain: 'luxury-homes-riverside.pages.dev',
  },
]
